...
Original file is located at
    https://colab.research.google.com/drive/1dVm-_U84h2eL3hKsu9h3wpDCHFsFr8Cu
"""
...
class TransformerModel(nn.Module):
    ...
    def forward(self, src: torch.Tensor, src_mask: torch.Tensor) -> torch.Tensor:
        ...
        # Apply the positional encoding to the embedded tokens
        embedded = self.pos_encoder(embedded)

        # Apply the transformer encoder layer to the embedded tokens
        output = self.transformer_encoder(embedded.transpose(0, 1), src_key_padding_mask=src_mask)  # (seq_len, batch_size, embedding_dim)
